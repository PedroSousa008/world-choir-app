...
const WorldChoirNav = (() => {
  ...
  const TAB_ASSETS = {
    ...
    profile: [
      ...
      'passport.html',
      'css/passport.css?v=20260827b',
      'js/profile/world-choir-passport.js?v=20260827b',
      'js/profile/passport-page.js?v=20260827b',
      'images/passport/passport-inside-bg.png?v=20260827a',
