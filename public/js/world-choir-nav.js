...
const WorldChoirNav = (() => {
  ...
  const TAB_ASSETS = {
    home: [
      ...
      'js/world-choir-home.js?v=20260921geocode1',
      'js/world-choir-db.js?v=20260921geocode1',
    ],
    map: [
      'map.html',
      ...
      'js/world-choir-map.js?v=20260921geocode1',
    ...
    donate: [
      ...
      'js/donate/donate-page.js?v=20260921funnel2',
