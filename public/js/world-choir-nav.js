...
const WorldChoirNav = (() => {
  ...
  const TAB_ASSETS = {
    ...
    profile: [
      ...
      'passport.html',
      'css/passport.css?v=20260821c',
      'js/profile/world-choir-passport.js?v=20260821c',
      'js/profile/passport-page.js?v=20260821c',
      'js/profile/passport-wallet.js?v=20260821c',
    ],
    memory: [
      'memory.html',
    ],
