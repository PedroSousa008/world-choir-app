...
const WorldChoirNav = (() => {
   ...
   * Keep versions EXACTLY in sync with each page's HTML (href/src).
   * Run: node scripts/verify-tab-assets.js
   */
  const TAB_ASSETS = {
    home: [
      'index.html',
      'css/inter-font.css?v=20260906perf',
      'css/world-choir-theme.css?v=20260904e',
      'css/home.css?v=20260905b',
      'css/privacy-consent.css?v=20260905a',
      'js/world-choir-config.js?v=20260906perf',
      'js/world-choir-db.js?v=20260906p2b',
      'js/world-choir-pledge-state.js?v=20260906p2b',
      'js/world-choir-pledge-state.js?v=20260904bx',
      'js/world-choir-nav.js?v=20260906p2b2',
      'js/world-choir-home.js?v=20260906p2b',
      'images/world-choir-logo.png?v=20260906perf',
    ],
    map: [
      'map.html',
      'css/inter-font.css?v=20260906perf',
      'css/map.css?v=20260903p',
      'js/map/sponsor-constants.js?v=20260902k',
      'js/map/sponsor-data.js?v=20260902a',
      'js/map/sponsor-bar.js?v=20260905a',
      '/api/map-sponsors',
      'js/world-choir-map-tiles.js?v=20260826h',
      'js/world-choir-map.js?v=20260903p',
      'js/world-choir-nav.js?v=20260906p2b2',
    ...
    donate: [
      ...
      'js/donate/donate-page.js?v=20260906perf',
      'js/world-choir-nav.js?v=20260906p2b2',
    ...
    profile: [
      'profile.html',
      'css/inter-font.css?v=20260906perf',
      'css/profile.css?v=20260906a',
      'js/profile/profile-page.js?v=20260906p2b',
      'js/profile/daily-acts-peace.js?v=20260906p2b',
      'js/profile/daily-acts-button.js?v=20260810i',
      'js/world-choir-onboarding.js?v=20260906perf',
      'js/world-choir-db.js?v=20260906p2b',
      'js/world-choir-practice-config.js?v=20260906perf',
      'js/profile/practice-mode.js?v=20260904c',
      'js/world-choir-nav.js?v=20260906p2b2',
      'passport.html',
      'css/passport.css?v=20260904a',
      'js/profile/passport-route.js?v=20260901b',
      'js/profile/world-choir-passport.js?v=20260906perf',
      'js/profile/passport-page.js?v=20260904b',
      'js/world-choir-flags.js?v=20260902n',
      'js/profile/pass-the-world-map.js?v=20260902b',
      'js/profile/pass-the-world.js?v=20260904a',
      'js/world-choir-map-tiles.js?v=20260826h',
      'images/passport/passport-inside-bg.png?v=20260906perf',
      'images/passport/passport-feature.png?v=20260906perf',
      'passport-story.html',
      '/api/pass-the-world',
      'https://unpkg.com/leaflet@1.9.4/dist/leaflet.css',
      'https://unpkg.com/leaflet@1.9.4/dist/leaflet.js',
    ...
    memory: [
      'memory.html',
      'css/inter-font.css?v=20260906perf',
      'css/memory-page.css?v=20260906perf',
    ...
    'daily-acts': [
      'daily-acts.html',
      'css/inter-font.css?v=20260906perf',
      'css/daily-acts-page.css?v=20260903p',
      'js/daily-acts-page.js?v=20260906p2b',
      'js/world-choir-nav.js?v=20260906p2b2',
    ],
  };
