...
const WorldChoirNav = (() => {
  ...
  const TAB_ASSETS = {
    home: [
      ...
      'js/world-choir-db.js?v=20260916scale',
    ],
    map: [
      'map.html',
      ...
      'js/world-choir-map.js?v=20260916zoomRestore',
    ...
    donate: [
      ...
      'css/donate.css?v=20260917rmCauses1',
      'js/donate/creator-foundations-store.js?v=20260917rmCauses1',
      'js/donate/donation-flow.js?v=20260917rmCauses1',
      'js/foundation-public-card.js?v=20260904cb',
      'js/donate/donate-page.js?v=20260917rmCauses1',
    ...
    profile: [
      ...
      'js/profile/pass-the-world.js?v=20260917ptwLive1',
      'js/world-choir-map-tiles.js?v=20260912ptwDark',
