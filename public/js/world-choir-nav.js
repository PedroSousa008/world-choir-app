...
const WorldChoirNav = (() => {
  ...
  const TAB_ASSETS = {
    home: [
      ...
      'js/world-choir-db.js?v=20260906perf',
    ],
    map: [
      'map.html',
      'css/map.css?v=20260906mapfix',
      'js/map/sponsor-constants.js?v=20260902k',
      'js/map/sponsor-data.js?v=20260902a',
      'js/map/sponsor-bar.js?v=20260905a',
      '/api/map-sponsors',
      'js/world-choir-map-tiles.js?v=20260906mapfix',
      'js/world-choir-map.js?v=20260906mapfix',
    ...
    profile: [
      ...
      'js/profile/profile-page.js?v=20260905a',
