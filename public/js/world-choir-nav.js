...
const WorldChoirNav = (() => {
  ...
  const TAB_ASSETS = {
    ...
    donate: [
      'donate.html',
      'css/donate.css?v=20260812g',
      'js/donate/creator-foundations-store.js?v=20260812g',
      'js/donate/donation-flow.js?v=20260812g',
      'js/donate/donate-page.js?v=20260812g',
