...
const WorldChoirNav = (() => {
  ...
  const TAB_ASSETS = {
    home: [
      ...
      'js/world-choir-home.js?v=20260813p',
    ...
    'daily-acts': [
      'daily-acts.html',
      'css/daily-acts-page.css?v=20260813j',
      'js/daily-acts-page.js?v=20260813j',
    ],
  };
