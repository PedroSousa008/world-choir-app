...
const WorldChoirNav = (() => {
  ...
  const TAB_ASSETS = {
    ...
    donate: [
      'donate.html',
      'css/donate.css?v=20260812i',
      'js/donate/creator-foundations-store.js?v=20260812i',
      'js/donate/donation-flow.js?v=20260812i',
      'js/donate/donate-page.js?v=20260812i',
