...
const WorldChoirNav = (() => {
  ...
  const TAB_ASSETS = {
    ...
    profile: [
      ...
      'passport.html',
      'css/passport.css?v=20260901e',
      'js/profile/passport-route.js?v=20260901b',
      'js/profile/world-choir-passport.js?v=20260901f',
      'js/profile/passport-page.js?v=20260901d',
      'js/world-choir-flags.js?v=20260901a',
      'js/profile/pass-the-world-map.js?v=20260901b',
      'js/profile/pass-the-world.js?v=20260901b',
      'js/world-choir-map-tiles.js?v=20260826d',
